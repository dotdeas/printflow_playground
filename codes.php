		...
		<div class="wrapper">
			...
			<div class="content-wrapper">
				...
				<section class="content">
					<div class="box">
						<div class="box-body">
							<table name="codes" id="codes" class="table table-bordered table-striped table-hover">
								<thead name="codeshead" id="codeshead">
									<tr>
										<th>Kod</th>
										<th>Typ</th>
										<th>Meddelande/Förbrukning</th>
									</tr>
								</thead>
								<tbody name="codesbody" id="codesbody">
				                    <?php
										echo codelist();
									?>
			                    </tbody>
							...
							<br>
							<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalnewcode">Ny kod</button>
						</div>
					</div>
				</section>
			</div>
			<?php
				...
				require("includes/modal-editcode.php");
