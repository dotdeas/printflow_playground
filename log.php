		...
		<div class="wrapper">
			...
			<div class="content-wrapper">
				...
				<section class="content">
					<div class="box">
						<div class="box-body">
							<table name="log" id="log" class="table table-bordered table-striped table-hover">
								<thead name="loghead" id="loghead">
									<tr>
										<th>Avtal</th>
										<th>Kod</th>
										<th>Meddelande/Förbrukning</th>
										<th>Rapport skickad</th>
									</tr>
								</thead>
								<tbody name="logbody" id="logbody">
				                    <?php
										echo loglist();
									?>
			                    </tbody>
